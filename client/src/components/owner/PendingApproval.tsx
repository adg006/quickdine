  ...
  return (
    <div className="max-w-xl mx-auto bg-white border border-outline-variant/20 p-8 text-center shadow-sm rounded-md space-y-6">
      ...
      <p className="text-sm text-black/55 leading-relaxed">
        ...
        <span className="text-black">{restaurant?.name}</span>. Your profile
        details and slots listing are currently under review by our Master
        Admin.
      </p>
      ...
      <p className="text-[10px] text-black/40 italic">
        You will receive full booking access as soon as your restaurant status
