        ...
        <div className="max-w-7xl mx-auto px-6 md:px-10 flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div className="space-y-3">
            <div className="flex flex-wrap gap-2 items-center">
              <span className="text-[10px] font-medium tracking-widest text-secondary-container bg-secondary py-1 px-3 uppercase">{restaurant.cuisine}</span>
              {restaurant.exclusive && <span className="text-[10px] font-medium tracking-widest text-white bg-primary border border-white/20 py-1 px-3 uppercase">EXCLUSIVE CLUB</span>}
            </div>

            <h1 className="font-display text-4xl md:text-5xl font-medium text-white tracking-tight leading-tight">{restaurant.name}</h1>
