      ...
      <div className="relative w-full max-w-md bg-white border border-outline-variant/30 ambient-shadow rounded-lg overflow-hidden z-10 transition-soft transform scale-100 flex flex-col">
        ...
        <div className="flex border-b border-outline-variant/20">
          <button
            ...
            className={`flex-1 py-5 text-center text-xs font-medium tracking-widest transition-soft cursor-pointer ${isLoginTab ? "text-primary border-b-2 border-primary bg-surface-container-lowest" : "text-black/55 hover:text-primary bg-surface-container-low/50"}`}
          >
            SIGN IN
          </button>
