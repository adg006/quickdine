                ...
                {otherRestaurants.map((r) => (
                  <tr key={r._id} className="hover:bg-surface/50">
                    ...
                    <td className="p-4 text-right space-x-3">
                      <span
                        className={`inline-block py-0.5 px-2 text-[9px] font-medium tracking-wider uppercase rounded-sm ${r.status === "approved" ? "bg-green-100 text-green-800" : "bg-error-container text-on-error-container"}`}
                      >
                        {r.status}
                      </span>
