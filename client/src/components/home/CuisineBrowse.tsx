    ...
    <section className="py-24 max-w-7xl mx-auto px-6 md:px-10">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
        {cuisines.map((c) => {
          ...
          return (
            <button key={c.name} onClick={() => handleCuisineClick(c.name)} className="group cursor-pointer text-center py-8 bg-white border border-outline-variant/20 hover:border-secondary transition-soft flex flex-col items-center justify-center">
